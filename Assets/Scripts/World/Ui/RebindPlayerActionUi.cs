...
namespace World.Ui
{
    public class RebindPlayerActionUi :MonoBehaviour
    {
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<RebindPlayerActionUi>();
        ...
        private static List<RebindPlayerActionUi> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<RebindPlayerActionUi, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<RebindPlayerActionUi, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
